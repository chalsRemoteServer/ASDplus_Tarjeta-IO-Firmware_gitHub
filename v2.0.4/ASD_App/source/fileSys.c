...
static char *ptr;
	...
	case 14:f_read(&f, buffer, 128, &read);estado61=19;break;
	case 15://read2=read;ptr=&buffer[0];estado61++;break;
	case 16://if(read2>0)estado61++;else{estado61+=3;}break;
	case 17://if(UART0->LSR_ICR_XON2 & MASK_UART_LSR_THRE)estado61++;break; // si no esta listo no pasa al siguiente
	case 18://estado61++;break;
	case 19://UART0->RHR_THR_DLL=*ptr++;read2--;
	...
	case 23:if(millis()>(delay1+1000)){estado61++;}break;
	case 24:f_close(&f);print1("\r\n\r\n");estado61++;break;
	case 25:delay1=millis();estado61++;break;
	case 26:if(millis()>(delay1+200)){estado61++;}break;
