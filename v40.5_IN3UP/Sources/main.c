...
//    run_Menu();				 
    ...
    delay_ms(1000);// Aqui se detiene , nopasa de aqui
  for(;;){	  
            Transmision_Consola();
            ...
            vTask5_Digital_Signal_Processor();//Procesador Central de las Señales analogas digitalizadas		
			...
			vTask4_Process_RX_VFD();
            vTask6_ADC_controller();
